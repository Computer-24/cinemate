...
export const Header = () => {
    ...
    return (<header>
        <nav className="bg-white border-gray-200 dark:bg-gray-900 dark:border-b-1 dark:border-grey-900">
                    ...
                    <div className="relative hidden md:block">
                        ...
                        <form onSubmit={handleSubmit}>
                            <input type="text" id="search-navbar"
                                   ...
                                   placeholder="Search..." autoComplete={"off"} name={"search"}/>
                        </form>
                    ...
                    <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg
                        ...
                        <li>
                            <NavLink to="/movies/popular"
                                     className={({isActive}) => isActive ? activeClass : inactiveClass}>Popular</NavLink>
                        </li>
                        <li>
                            <NavLink to="/movies/top"
                                     className={({isActive}) => isActive ? activeClass : inactiveClass}>Top
                                rated</NavLink>
                        </li>
                        <li>
